...
Public Class tablacompras
    ...
    Private Sub tablafacturas_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        consultar("select * from compras where id=0 order by id")
    ...
    Private Sub activar_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles activar.Click
        ...
        If MsgBox("Estas seguro de eliminar este Registro", MsgBoxStyle.OkCancel, "Confirmación") = MsgBoxResult.Ok Then
            Try
                ...
                Dim agrega As String = "delete from compras where ID=@id"
            ...
            Catch ex As Exception
                conexion.Close()
                MsgBox("Ocurrio un Error :( no se pudo eliminar", MsgBoxStyle.Exclamation, "Eliminacion")
            End Try
        Else
    ...
    Private Sub Button3_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles Button3.Click
        ...
        If guardar.FileName.Length > 0 Then
            exportaraexcelfacturas(Gridfactura, guardar.FileName, "Compras")
        Else
    ...
    Public Sub consultaformada()
        ...
        If Trim(comprador.Text).Length > 0 Then

            If antes = 1 Then
                consulta = consulta & " and comprador like '%" & Trim(comprador.Text) & "%' "
            Else
                consulta = consulta & " WHERE comprador like '%" & Trim(comprador.Text) & "%' "
            End If
            antes = 1
        End If
        ...
        If recibo.Checked = True Then
            ...
            Else
                consulta = consulta & " WHERE FECHA_RECIBO BETWEEN " & cadena & cadena2
            End If
            antes = 1
        End If
