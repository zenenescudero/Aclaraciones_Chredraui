...
Public Class resumendiferencias
    ...
    Public Sub excelfacturas()
        ...
        If guardar.FileName.Length > 0 Then
            exportaraexcelfacturas(Gridfactura, guardar.FileName, "ResumenDiferencias")
        Else
    ...
    Public Sub formarconsulta()
        ...
        Dim consulta As String = "select STATUS,CONCEPTO,AREA,CLAVE,DESCRIPCION,count(*) AS CASOS,SUM(DIFERENCIA) AS SUMADIFERENCIA from diferenciaydatos where "
        consulta = consulta & " FECHA_RESPUESTA BETWEEN " & cadena & cadena2 & " OR STATUS='PENDIENTE' GROUP BY STATUS,AREA,CLAVE ORDER BY STATUS,CLAVE"
        'MsgBox(consulta)
        consultar(consulta)
    ...
    Private Sub Button1_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles Button1.Click
        If Gridfactura.RowCount > 0 Then
            excelfacturas()
        Else
            MsgBox("la consulta no encontro datos", MsgBoxStyle.Information, "Diferencias")
        End If
    End Sub
