...
Public Class Rango_de_Consulta
    ...
    Public Sub formarconsulta()
        ...
        Dim consulta As String = "select STATUS,CONCEPTO,AREA,CLAVE,DESCRIPCION,count(*) AS CASOS,SUM(IMPORTE) AS SUMAIMPORTE from facturaydatos where "
