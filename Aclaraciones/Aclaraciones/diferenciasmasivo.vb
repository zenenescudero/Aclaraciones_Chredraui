...
Public Class diferenciasmasivo
    ...
    Public Sub guardar()
        ...
        Try
            idinicial = obteneruncampo("select max(id) from diferencias")
        Catch ex As Exception
            idinicial = 0
        End Try
        ...
        Dim agrega As String = "call insertardiferencia(" '" & Trim(TABLA.Text) & " values("
        ...
        If CheckBox1.Checked Then
            Try
                conexion.Open()
                Dim coman As New MySqlCommand("delete from diferencias where id<=" & idinicial & "", conexion)
    ...
    Public Sub cargafail(ByVal fila As Integer)
        Try
            conexion.Open()
            Dim coman As New MySqlCommand("delete from diferencias where id>" & fila & "", conexion)
            coman.CommandType = CommandType.Text
            coman.ExecuteNonQuery()
            conexion.Close()
        Catch ex As Exception
